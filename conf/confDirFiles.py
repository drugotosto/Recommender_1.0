...
from conf.confRS import tag, numRec
...
dirPathInput="/home/maury/Desktop/SparkSets/"+tag+"/DataSet_(numRec="+str(numRec)+")/"
...
dirPathOutput="/home/maury/Desktop/SparkOutput/"+tag+"/DataSet_(numRec="+str(numRec)+")/"
